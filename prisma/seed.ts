...
async function main() {
  ...
  const products = [
    ...
    { name: 'Noor Cutwork Lace Co-ord', slug: 'noor-cutwork-lace-coord', sku: 'HA-WW-CO-250', cat: 'co-ords', price: 4799, mrp: 5699, fabric: 'Cotton poplin with floral cutwork lace overlay', desc: 'A relaxed collared shirt and short set with intricate scalloped cutwork lace throughout — a directional evening-into-daywear piece.', images: [img(211), img(212)], colls: ['luxury'], featured: true, isNew: true, tags: ['cutwork', 'lace', 'co-ord', 'black'] },
    { name: 'Vera Stitched Denim Vest Co-ord', slug: 'vera-stitched-denim-vest-coord', sku: 'HA-WW-CO-251', cat: 'co-ords', price: 3899, mrp: 4599, fabric: 'Structured denim with contrast topstitching', desc: 'A sleeveless denim vest with utility pockets, drawstring waist and matching tapered trousers — off-duty tailoring with an edge.', images: [img(216), img(217)], colls: ['summer', 'winter'], isNew: true, tags: ['denim', 'co-ord', 'vest', 'utility'] },
    { name: 'Kiah Denim Shirt & Trouser Set', slug: 'kiah-denim-shirt-trouser-set', sku: 'HA-WW-CO-252', cat: 'co-ords', price: 3699, mrp: 4399, fabric: 'Washed denim with white contrast stitching', desc: 'A relaxed denim shirt with front lacing detail paired with straight trousers for an easy weekend uniform.', images: [img(218), img(219)], colls: ['summer'], tags: ['denim', 'shirt set', 'casual'] },
    { name: 'Devika Mirror-Trim Kurta Set', slug: 'devika-mirror-trim-kurta-set', sku: 'HA-IW-KS-153', cat: 'kurta-sets', price: 3199, mrp: 3799, fabric: 'Cotton with mirror and thread embroidered yoke', desc: 'A relaxed straight kurta with a heavily embroidered mirror-work yoke, paired with matching straight pants for festive daywear.', images: [img(445), img(446)], colls: ['festive'], isNew: true, tags: ['kurta set', 'mirror work', 'indowestern'] },
    { name: 'Roohi Palm Print Tunic Set', slug: 'roohi-palm-print-tunic-set', sku: 'HA-IW-KS-154', cat: 'kurta-sets', price: 2899, mrp: 3499, fabric: 'Cotton slub with placement palm print', desc: 'A camel tunic with a bold ivory palm-leaf print, tasselled front tie and lace-trimmed sleeves, styled over relaxed sharara pants.', images: [img(447), img(448)], colls: ['summer', 'festive'], tags: ['tunic', 'printed', 'indowestern'] },
    { name: 'Aanya Cobalt Applique Kurta', slug: 'aanya-cobalt-applique-kurta', sku: 'HA-IW-KS-155', cat: 'kurta-sets', price: 2999, mrp: 3599, fabric: 'Cotton with floral lace applique', desc: 'A vivid cobalt blue V-neck tunic with statement floral lace appliques, paired with a flowing farshi salwar for standout festive dressing.', images: [img(449), img(450)], colls: ['festive'], isNew: true, tags: ['applique', 'kurta', 'blue'] },
    { name: 'Ishani Block Print Kurta Set', slug: 'ishani-block-print-kurta-set', sku: 'HA-IW-KS-156', cat: 'kurta-sets', price: 2599, mrp: 3199, fabric: 'Pure cotton with hand block print border', desc: 'A crisp white kurta set with an indigo block-printed border on sleeves and hem, paired with matching palazzos.', images: [img(451), img(452)], colls: ['summer'], tags: ['block print', 'kurta set', 'indigo'] },
    { name: 'Sana Threadwork Kurta Set', slug: 'sana-threadwork-kurta-set', sku: 'HA-IW-KS-157', cat: 'kurta-sets', price: 2799, mrp: 3399, fabric: 'Cotton with dense thread embroidery', desc: 'A rich indigo kurta with all-over paisley thread embroidery in white, paired with matching palazzos and tassel details.', images: [img(453), img(454)], colls: ['festive'], tags: ['threadwork', 'kurta set', 'indigo'] },
    { name: 'Meera Floral Lace Shirt', slug: 'meera-floral-lace-shirt', sku: 'HA-WW-SH-253', cat: 'shirts', price: 2699, mrp: 3199, fabric: 'Cotton poplin with floral cutwork lace panel', desc: 'A blush pink shirt with a statement multicolour floral cutwork lace front panel, worn open or buttoned for a directional daytime look.', images: [img(334), img(336)], colls: ['summer', 'luxury'], isNew: true, tags: ['lace', 'shirt', 'floral'] },
